...
var result = {
  ...
  INFJ: {
    ...
    list2: "업무적인 이해 관계자를 설득할 수 있는 소통 능력",
  ...
  INFP: {
    ...
    list1: "카피라이팅 능력",
    list2: "제작 툴 활용 능력 : 포토샵, 프리미어, 일러스트 등",
    list3: "소비자 트렌드 파악 역량 : SNS, 콘텐츠, 이슈 등",
    list4: "SEO에 대한 이해",
  },
  ENFJ: {
    img: "enfj.jpeg",
  ...
  ENFP: {
    ...
    list2: "소비자 트렌드 파악 역량 : SNS, 콘텐츠, 이슈 등",
    list3: "미디어 및 광고 생태계에 대한 이해",
    list4: "비즈니스 커뮤니케이션 역량",
  },
  ISTJ: {
    img: "istj.jpeg",
    mbti: "ISTJ",
